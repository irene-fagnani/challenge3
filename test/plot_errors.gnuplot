...
set format y "%3.1e"
set title "L2 norm error as function of matrix dimension"
set xlabel "Grid size n"
set ylabel "L2 norm error"
set logscale y 10
set grid
set style line 1 lc rgb "red" lw 2 pt 7
set style line 2 lc rgb "blue" lw 2 pt 7
set style line 3 lc rgb "green" lw 2 pt 7
plot "data/errors.dat" using ($1 == 1 ? $2 : 1/0):3 with linespoints linestyle 1 title "Core number 1", \
